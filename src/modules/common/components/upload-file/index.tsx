...
export function UploadFile(props: Props) {
  ...
  return (
    <div className={`flex flex-grow  flex-col gap-4 `}>
      <button
        className={` flex justify-center border-2 rounded-lg flex-col border-dashed gap-4 items-center hover:border-black py-4 ${
          !props.multiple ? 'min-h-[20rem]' : ' min-h-16'
