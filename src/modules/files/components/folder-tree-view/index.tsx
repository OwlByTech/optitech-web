...
export function FolderViewTree({
  ...
  return (
    <>
      <Button
        className={`hover:bg-gray-50 flex flex-row w-full items-center justify-between h-8 rounded-lg bg-white text-black   text-xs gap-2 ${
          directory?.open ? "bg-gray-100 border-none " : "border"
        } ${
