...
import { CreateDocumentModal } from "../components/create-document";
    ...
    return (
        <DragAndDrop
            ...
            onDrop={async (e) => {
                console.log("drop")
                try {
                    filesValidations(e.dataTransfer.files, ['pdf', '.docx'], 30)
        ...
        >
            {(files?.length > 0) && <CreateDocumentModal files={files} curDir={props.directory} setFiles={setFiles} />}
            <div
