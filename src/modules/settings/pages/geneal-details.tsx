        ...
        <div className="flex flex-grow gap-x-[20px]">
          <div className="flex flex-col w-[250px] gap-y-[20px] pt-1: ">
            ...
            <div className="flex flex-grow justify-between">
              <Button
                startContent={<FiEdit />}
                className="rounded-xl text-black bg-gray-200 hover:bg-white hover:border hover:border-gray-300"
              >
                Cambiar
              </Button>
              <Button
          ...
          <div className="flex flex-col flex-grow">
            ...
            <div className="flex flex-grow gap-5 justify-end">
              <Button className="rounded-xl bg-white text-black hover:bg-gray-200">
                Restablecer
              </Button>
              <SubmitButton className="rounded-xl text-black bg-gray-200 hover:bg-white">
                Actualizar
              </SubmitButton>
            </div>
          </div>
